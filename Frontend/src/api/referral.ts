...
export const rejectReferral = (referralId: number) =>
  api.post<ApiResponseDTO<null>>(`/referral/${referralId}/reject`);

export const getSubmittedPendingReferrals = () =>
  api.get<ApiResponseDTO<ReferralDTO[]>>(`/referral/submitted`);
